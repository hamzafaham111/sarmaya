    ...
    <main className="mx-auto w-full max-w-3xl px-6 pb-24">
      <header className="flex items-baseline justify-between py-8">
        <div>
          <h1 className="font-display text-4xl text-ink">
            Sarmaya <span className="text-ink-muted italic">styleguide</span>
          </h1>
          <p className="mt-1 text-sm text-ink-muted">
            The UI contract. Dark is home; toggle to verify light.
          </p>
        </div>
        <ThemeToggle />
      </header>
      ...
      >
        <p className="font-display text-3xl text-ink">
          Reliance Industries <span className="italic">— display face</span>
        </p>
